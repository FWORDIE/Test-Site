...
function showResults(num, runaway, instant) {
    ...
    for(let i = 0; i <=3;i++){
        ...
        for(let j = 0; j <points[i].length;j++){
            ...
            let pointyXOffest = points[i][j][0] + (i*(containerWidth/4)) + padding;
